...
import com.example.retrofit.servicioYrepositorio.CalculadoraRepositorio;
...
public class Calculadora extends AppCompatActivity {
    ...
    public void sumaApi(int num1, int num2) {
        ...
        llamada = CalculadoraRepositorio.getInstance().suma(num1,num2);
    ...
    public void restaApi(int num1, int num2) {
        ...
        llamada = CalculadoraRepositorio.getInstance().resta(num1,num2);
        llamada.enqueue(new Callback<Resultado>() {
            @Override
            public void onResponse(Call<Resultado> call, Response<Resultado> response) {
                label.setText(response.body().resultado);
    ...
    public void multiApi(int num1, int num2) {
        ...
        llamada = CalculadoraRepositorio.getInstance().multi(num1,num2);
        llamada.enqueue(new Callback<Resultado>() {
            @Override
            public void onResponse(Call<Resultado> call, Response<Resultado> response) {
                label.setText(response.body().resultado);
    ...
    public void divApi(int num1, int num2) {
        ...
        llamada = CalculadoraRepositorio.getInstance().div(num1,num2);
        llamada.enqueue(new Callback<Resultado>() {
            @Override
            public void onResponse(Call<Resultado> call, Response<Resultado> response) {
                label.setText(response.body().resultado);
